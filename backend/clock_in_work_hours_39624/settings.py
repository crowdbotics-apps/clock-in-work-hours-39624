"""
Django settings for clock_in_work_hours_39624 project.
...
ROOT_URLCONF = 'clock_in_work_hours_39624.urls'
...
WSGI_APPLICATION = 'clock_in_work_hours_39624.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "clock_in_work_hours_39624 API",
    "DESCRIPTION": "API documentation for clock_in_work_hours_39624 App",
    "VERSION": "v1",
}
